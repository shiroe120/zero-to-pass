...
这是一个简单好用的AI SKILL，能够帮一个学期都没听课的你快速复习至及格水平。采取最简单有效的应试策略，你只需提供一份或者多份试卷，该技能即可逐题生成结构化的复习资料，涵盖：

- **原题呈现** - 原汁原味的题目内容
- **知识点补充** - 从零讲起，补充足够的前置知识，逐步延伸到本题所需深度，保证任何基础的学生都能理解
...
在 Markdown 中引用图片时，路径为：

```markdown
![图片说明](images/你的图片.png)
```
